package com.github.dmstocking.putitonthelist.grocery_list.cloud_firstore;
...
@Singleton
public class GroceryListRepositoryCloudFirestore implements GroceryListRepository {
    ...
    @Inject
    public GroceryListRepositoryCloudFirestore(@NonNull FirebaseFirestore fireStore,
    ...
    @Override public Flowable<List<GroceryListItemDocument>> getGroceryListDocument(@NonNull GroceryListId id) {
    ...
    @Override public Completable create(GroceryListId listId,
                              String category,
                              String name) {
    ...
    @Override public Completable update(GroceryListId listId,
    ...
    @Override public Completable deletePurchased(GroceryListId listId) {
