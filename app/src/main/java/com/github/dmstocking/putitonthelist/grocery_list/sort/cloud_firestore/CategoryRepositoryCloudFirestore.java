package com.github.dmstocking.putitonthelist.grocery_list.sort.cloud_firestore;
...
@Singleton
public class CategoryRepositoryCloudFirestore implements CategoryRepository {
    ...
    @Inject
    public CategoryRepositoryCloudFirestore(@NonNull FirebaseFirestore firestore,
                              @NonNull Log log) {
